...
Future<List<Post>?> ReadAllPosts() async {
  ...
  final url = Uri.parse('http://192.168.1.18:8080/Post/ReadAll');
  try {
    final response =
...
Future<void> UploadPost(Post post) async {
  ...
  String? loginValues = prefs.getString('loginValues');
  final url = Uri.parse('http://192.168.1.18:8080/Post/Posting');
  try {
...
Future<void> UpdatePost(int id, Post post) async {
  ...
  String? loginValues = prefs.getString('loginValues');
  final url = Uri.parse('http://192.168.1.18:8080/Post/Update/$id');
  try {
...
Future<void> DeletePost(int id) async {
  ...
  String? loginValues = prefs.getString('loginValues');
  final url = Uri.parse('http://192.168.1.18:8080/Post/Delete/$id');
  try {
